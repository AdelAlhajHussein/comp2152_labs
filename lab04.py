...
m_compat_strength = min(6, m_combat_strength + monster_powers[monster_power])

print(f"Monster got {monster_power}, increasing their combat strength to {m_compat_strength}")
